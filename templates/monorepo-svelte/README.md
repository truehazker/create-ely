# Monorepo Template (SvelteKit)

This is a monorepo template containing a full-stack application with a backend (ElysiaJS) and frontend (SvelteKit) application.
...
2. **Configure environment variables**
   ...
   - **Frontend**: See [apps/frontend/README.md](./apps/frontend/README.md) for required environment variables (e.g., `PUBLIC_API_URL`)
